...
# Load data for Fig2a
library(readxl)
Fig1 <- read_excel("~/Desktop/LGF_Fig1_Rdata_240722.xlsx")
...
ggsave("LGF_Fig1_20240722.jpg", plot = Fig1Plot, units = "in", dpi = 300, width = 5, height = 5)
...
# Load data for Fig2a
Fig2a <- read_excel("~/Desktop/LGF_Fig2a_Rdata_240722.xlsx")
...
# Load data for Fig2b
Fig2b <- read_excel("~/Desktop/LGF_Fig2b_Rdata_240722.xlsx")
...
ggsave("LGF_Fig2_240722.jpg", plot = combined_plot, units = "in", dpi = 300, width = 10, height = 5)
...
# Load data for Fig3a
library(readxl)
Fig3a <- read_excel("LGF_Fig3a_Rdata_240722.xlsx")
Fig3a$change_laz_factor <- as.factor(Fig3a$change_laz)
Fig3a$laz0_factor <- as.factor(Fig3a$laz0)
...
# Load data for Fig3b
Fig3b <- read_excel("LGF_Fig3b_Rdata_240722.xlsx")
Fig3b$corr_factor <- as.factor(Fig3b$correlation)
Fig3b$laz0_factor <- as.factor(Fig3b$LAZ0)
...
# Save the combined plot as a jpeg
ggsave("LGF_Fig3_240722.jpg", plot = combined_plot, units = "in", dpi = 300, width = 8, height = 6)
...
SA_monthly <- read_excel("LGF_Fig4_Rdata_240722.xlsx")
...
ggsave("LGF_Fig4_240722.jpg", plot = Fig4, units = "in", dpi = 300, width = 10, height = 2.5)
