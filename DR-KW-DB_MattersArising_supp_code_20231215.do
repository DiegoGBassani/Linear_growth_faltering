...
count if laz0<-2 // # classified as 'stunted' at birth = 1676
display 1676/9000 // manual calculation of stunting prev. (# stunted/total N)
* Determine incident stunting onset between 0-3 mos
count if laz0>=-2 & laz3<-2 & tag==0 // normal calculation of 'newly stunted' = 1046
count if laz3<-2 & tag==1 // Infants with missing birth measurements were considered `newly stunted' if their 3-month LAZ <-2 = 255
display (1046+255)/10000 // (full sample size now as denominator as now missingness at 3-months)
...
replace laz0 =. if tag==1
* Repeat steps above for determining stunting prev and incident stunting onset between 0-3mos
